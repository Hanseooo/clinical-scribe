...
const steps = [
  ...
  },
  {
    ...
    title: 'AI Structures',
    description:
      'Gemini 2.5 Flash transcribes and organizes your input into a structured ISBAR, SBAR, or ISOBAR format.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-24 pt-20 sm:pb-32 sm:pt-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-500 sm:text-xl">
              Record a patient handover or paste your notes — get a clean, structured
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 sm:py-28">
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-slate-500">
              Switch between templates anytime. ISBAR is the default — most common in Philippine nursing curricula.
            </p>
          </div>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <p className="text-sm text-slate-400">
              Verify all clinical data before use.
            </p>
          </div>
        </div>
      </footer>
